...
class DataCollection {
    ...
    private ASCIIDataFile input;     //The input file which stores the household address.
    private ASCIIOutputFile output;  //The output file as a census table.
    private BasicForm houseHold;     //The form which processes the number of residents.
    private BasicForm individual;    //The form which processes the information of individual.

    private String address;          //Household address.
    private int totalNum;            //Total number of person per house.
    private int maleNum;             //Number of males per house.
    private int femaleNum;           //Number of females per house.
    private int engSpker;            //Number of English speakers per house.
    private int frenSpker;           //Number of French speakers per house.
    private int otherSpker;          //Number of other language speakers per house.
...
// instance variables
    ...
    /** This method writes the information as a table into a output file
     *
     * @param address the household's address
     * @param totalNum the total number of residents
     * @param maleNum the number of males
     * @param femaleNum the number of females
     * @param engSpker the number of English speakers
     * @param frenSpker the number of French speakers
     * @param otherSpker the number of other speakers
     * */
    private void writeTable(String address,int totalNum,int maleNum,int femaleNum
                                        ,int engSpker,int frenSpker,int otherSpker) {
